...
> Auto-maintained by OpenWolf. Last scanned: 2026-05-08T15:18:10.974Z
...
- `MarkdownEditor.vue` — Vue: setup, emits (~1352 tok)
...
- `KatexDisplay.vue` — Vue: setup (~164 tok)
...
- `useKatex.js` — Exports useKatex (~287 tok)
...
- `AdminLayout.vue` — Vue: setup (~2940 tok)
- `DefaultLayout.vue` — Vue: setup (~485 tok)
- `PortalLayout.vue` — Vue: setup (~1040 tok)

## src/router/

- `index.js` — Declares routes (~1718 tok)

## src/services/

- `dataService.js` — DSE 学情问诊系统 — 中央数据服务（localStorage 模拟后端） (~12448 tok)

## src/stores/

- `app.js` — Exports useAppStore (~596 tok)
- `index.js` (~19 tok)

## src/styles/

- `admin.css` — Styles: 70 rules, 58 vars (~8187 tok)
- `main.css` — Styles: 81 rules, 30 vars (~7148 tok)
...
- `Mistakes.vue` — Vue: setup (~482 tok)
- `Practice.vue` — Vue: setup (~676 tok)
...
- `CircleLine.vue` — Vue: setup (~486 tok)
- `Composite.vue` — Vue: setup (~2750 tok)
- `Geometry3D.vue` — Vue: setup (~7788 tok)
- `Inequality.vue` — Vue: setup (~428 tok)
- `Locus.vue` — Vue: setup (~352 tok)
- `LogExp.vue` — Vue: setup (~2722 tok)
- `MovingPoint.vue` — Vue: setup (~3044 tok)
- `Numbers.vue` — Vue: setup (~374 tok)
- `Polynomial.vue` — Vue: setup (~401 tok)
- `Probability.vue` — Vue: setup (~378 tok)
- `Quadratic.vue` — Vue: setup (~2491 tok)
- `Sequence.vue` — Vue: setup (~344 tok)
- `Statistics.vue` — Vue: setup (~386 tok)
- `TriangleCenter.vue` — Vue: setup (~439 tok)
...
- `MyMistakes.vue` — Vue: setup (~2112 tok)
...
- `Chinese.vue` — Vue: setup (~9452 tok)
