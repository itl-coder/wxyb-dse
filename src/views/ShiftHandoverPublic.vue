      ...
      <div ref="exportRef" class="hop-export-area">
        ...
        <div v-for="d in weekDaysWithRecords" :key="d.key" class="hop-day-section">
          ...
          <template v-if="d.record">
            ...
            <!-- 会议纪要 -->
            <div v-if="d.record.sections?.meeting && d.record.meetingNotes?.hasMeeting" class="hop-block">
            ...
            <!-- 手机管理 -->
            <div v-if="d.record.sections?.phones && d.record.phoneManagement" class="hop-block hop-phone-block">
            ...
            <!-- 请假记录 -->
            <div v-if="d.record.sections?.leave && d.record.leaveRecords?.length" class="hop-block">
            ...
            <!-- 备注 -->
            <div v-if="d.record.sections?.notes && d.record.generalNotes" class="hop-block">
        ...
        <div v-if="weekDaysWithRecords.length === 0" class="hop-all-empty">
          ...
          <p>本周暂无交接内容记录</p>
          <p class="hop-all-empty-sub">各天班次配置后，请前往 <a href="/admin/handover" style="color:var(--accent)">管理后台</a> 填写交接数据
          </p>
        </div>
      </div>
    </template>
